...
//                                                        //
////////////////////////////////////////////////////////////
__STATIC_FORCEINLINE void __mpy_start(uint_fast16_t *ui16IntState, uint_fast16_t *ui16MPYState)
{
    /* Do nothing. */
    return;
}

__STATIC_FORCEINLINE void __mpyf_start(uint_fast16_t *ui16IntState, uint_fast16_t *ui16MPYState)
{
    /* Do nothing. */
    return;
}

__STATIC_FORCEINLINE void __mpyfs_start(uint_fast16_t *ui16IntState, uint_fast16_t *ui16MPYState)
{
    /* Do nothing. */
    return;
}

__STATIC_FORCEINLINE void __mpy_clear_ctl0(void)
{
    /* Do nothing. */
    return;
}

__STATIC_FORCEINLINE void __mpy_set_frac(void)
{
    /* Do nothing. */
    return;
}

__STATIC_FORCEINLINE void __mpy_stop(uint_fast16_t *ui16IntState, uint_fast16_t *ui16MPYState)
{
    /* Do nothing. */
    return;
}
